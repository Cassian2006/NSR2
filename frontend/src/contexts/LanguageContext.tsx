...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "compliance.title": "Compliance & Safety Notice",
    "compliance.researchOnly": "Research use only, not for direct navigation command.",
    "compliance.freshness": "Data Freshness",
    "compliance.sourceHealth": "Source Health",
    "compliance.updatedAt": "Updated At",
    "compliance.status.fresh": "Fresh",
    "compliance.status.stale": "Stale",
    "compliance.status.outdated": "Outdated",
    "compliance.status.unknown": "Unknown",
    ...
    "summary.riskConstraint.none.title": "Risk Constraint Disabled",
    "summary.riskConstraint.none.desc": "Current policy does not enable chance/cvar risk budget constraints.",
    "summary.riskConstraint.pass.title": "Risk Constraint Passed",
    "summary.riskConstraint.fail.title": "Risk Constraint Failed",
    "summary.riskConstraint.usage": "Budget usage",
    "summary.riskConstraint.metric": "Metric",
    ...
    "export.deleted": "deleted",
    "export.input": "Input",
    "export.result": "Result",
    "export.runDetails": "Run Details",
    "export.recycleList": "Recycle List",
    "export.restore": "Restore",
    "export.model": "Model",
    "export.inputAndResult": "Input and Result",
    "export.riskSummary": "Risk Summary and Explainability Exports",
    "export.status.loading": "loading...",
    "export.status.ready": "ready",
    "export.status.unavailable": "not available",
    "export.riskExposure": "Risk Exposure",
    "export.highRiskCrossing": "High-risk Crossing",
    "export.avoidanceGain": "Avoidance Gain",
    "export.distanceTradeoff": "Distance Tradeoff",
    "export.noRiskReport": "No risk report yet (legacy run or pending generation).",
    "export.downloadTemplate.json": "Download Template (JSON)",
    "export.downloadTemplate.csv": "Download Template (CSV)",
    "export.downloadTemplate.md": "Download Template (MD)",
    "export.downloadRiskReport": "Download Risk Report",
    "export.downloadCandidateCompare": "Download Candidate Compare",
    "export.deleteConfirm.prefix": "Delete run",
    "export.deleteConfirm.suffix": "? You can restore it from the recycle list.",
    "export.resultCaution": "caution",
    "export.noRiskReportDownload": "No risk report available",
    "export.noCandidateCompareDownload": "No candidate comparison available",
    ...
    "toast.runMovedToRecycle": "Run moved to recycle list",
    "toast.runRestored": "Run restored",
    "toast.restoreFailed": "Restore failed",
    "toast.riskReportDownloaded": "Risk report downloaded",
    "toast.candidateCompareDownloaded": "Candidate comparison downloaded",
    "toast.reportTemplateDownloaded": "Report template downloaded",
    "toast.reportTemplateDownloadFailed": "Report template download failed",
  },
  zh: {
    ...
    "compliance.title": "合规与安全提示",
    "compliance.researchOnly": "仅用于科研参考，不构成直接航行指令。",
    "compliance.freshness": "数据时效",
    "compliance.sourceHealth": "数据源健康",
    "compliance.updatedAt": "更新时间",
    "compliance.status.fresh": "新鲜",
    "compliance.status.stale": "轻度过时",
    "compliance.status.outdated": "过时",
    "compliance.status.unknown": "未知",
    ...
    "summary.riskConstraint.none.title": "未启用风险约束",
    "summary.riskConstraint.none.desc": "当前策略未启用 chance/cvar 风险预算约束。",
    "summary.riskConstraint.pass.title": "风险约束通过",
    "summary.riskConstraint.fail.title": "风险约束未通过",
    "summary.riskConstraint.usage": "预算占用",
    "summary.riskConstraint.metric": "指标",
    ...
    "export.input": "输入",
    "export.result": "结果",
    "export.runDetails": "运行详情",
    "export.recycleList": "回收站",
    "export.restore": "恢复",
    "export.model": "模型",
    "export.inputAndResult": "输入与结果",
    "export.riskSummary": "风险摘要与可解释导出",
    "export.status.loading": "加载中...",
    "export.status.ready": "已生成",
    "export.status.unavailable": "不可用",
    "export.riskExposure": "风险暴露",
    "export.highRiskCrossing": "高风险穿越比",
    "export.avoidanceGain": "规避收益",
    "export.distanceTradeoff": "距离代价",
    "export.noRiskReport": "该记录暂无风险报告（可能为旧记录或尚未生成）。",
    "export.downloadTemplate.json": "下载标准报告 (JSON)",
    "export.downloadTemplate.csv": "下载标准报告 (CSV)",
    "export.downloadTemplate.md": "下载标准报告 (MD)",
    "export.downloadRiskReport": "下载风险报告",
    "export.downloadCandidateCompare": "下载候选对比",
    "export.deleteConfirm.prefix": "确认删除记录",
    "export.deleteConfirm.suffix": "？可在回收站中恢复。",
    "export.resultCaution": "谨慎区",
    "export.noRiskReportDownload": "暂无风险报告可下载",
    "export.noCandidateCompareDownload": "暂无候选对比可下载",
    ...
    "toast.runMovedToRecycle": "记录已移入回收站",
    "toast.runRestored": "记录已恢复",
    "toast.restoreFailed": "恢复失败",
    "toast.riskReportDownloaded": "风险报告已下载",
    "toast.candidateCompareDownloaded": "候选对比报告已下载",
    "toast.reportTemplateDownloaded": "标准报告已下载",
    "toast.reportTemplateDownloadFailed": "下载标准报告失败",
  },
};
